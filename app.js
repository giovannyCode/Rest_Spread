...
function findMin(...numbers){
 return numbers.reduce((min,CurrentValue) =>{return CurrentValue<min ? CurrentValue:min }
  )
...
function mergeObjects(val1, val2){
...
{
     const valuesDoubled = values.map(val=> val* 2);

     return [...arr,...valuesDoubled];
}
